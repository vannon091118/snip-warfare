...
_Stand: V0.02 — 344 Klassen mit `class_name` im Projekt, davon 308 in den 14 Domaenen-Ordnern und 36 ohne Domaenen-Ordner, 68 Signale, 35 Array-Elementtypen und 35 JSON-Pools._
...
### world/welt — Prefix `Welt_` — `world/logic/kategorie_welt/` (62)
...
| `Welt_ModelNeu` | `world/logic/kategorie_welt/welt_model_neu.gd` |
