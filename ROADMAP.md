...
* **Klassenbestand:** 331 Klassen auf 367 GDScript-Dateien — Inventar siehe [`INDEX.md`](INDEX.md) via `python tools/index_generieren.py`
...
* **Testabdeckung:** 149 Pytest-Fälle grün, Preflight-Prüfung (Kategorien 1–19 inkl. Whitespace E042, Version E043 und Index E044) grün (0 Befunde), dazu die Laufbeweise `tools/lauf_pruefung_hud.gd` und `tools/lauf_pruefung_makrokarte.gd`
